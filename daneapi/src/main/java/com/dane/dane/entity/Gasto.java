...
public class Gasto {
  ...
  public Gasto(long idtipogasto, double valorpropio, long idmonedapropio, double valornotercero, long idmonedatercero, double valorsitercero, long idmonedasitercero, long numpersonas, long idencuesta) {
